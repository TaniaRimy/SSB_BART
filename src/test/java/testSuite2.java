...
//@SuiteClasses({ Organization.class, User.class, Run_test_on_Accessibility_Demand.class, Run_Test_from_Bulk_Action_Bar_Module_Test.class, Compliance_Count.class })
